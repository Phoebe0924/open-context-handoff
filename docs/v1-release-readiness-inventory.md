...
| `docs/repo-map.md` | Navigation | Explains repository layers and starting path | Current; includes release-candidate and validation-summary paths |
...
| `tests/v1-validation-summary.md` | Validation | Summarizes V0 evidence and V1 Run 001 without overclaiming | Current |
...
| `docs/v1-release-gap.md` | Release record | Records remaining release-candidate decisions and evidence limits | Current |
...
| `docs/v1-release-notes.md` | Release record | Drafts factual V1 release notes | Current; awaiting human review |
| `docs/v1-final-consistency-check.md` | Release record | Records final protocol, scope, and preservation checks | Current |
| `RELEASE_CHECKLIST.md` | Release record | Provides human release-candidate review checks | Current |
